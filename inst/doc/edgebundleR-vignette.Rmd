---
title: "A brief guide to edgebundleR"
output: html_document
---

<!--
%\VignetteEngine{knitr::knitr}
%\VignetteIndexEntry{A brief guide to edgebundleR}
-->

# A brief quide to edgebundleR
...
A shiny web interface to facilitate interaction with the plot will be available in future versions of `edgebundleR`.
